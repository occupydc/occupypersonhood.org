<?php /* Global Post file. */ ?>
	...
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?> >
		...
		<div class="post-content">
			...
			<div class="post-meta">
				<span class="post-meta-info"><?php the_time( __('F jS, Y', 'cp') ); ?> &middot; <?php the_author_posts_link(); ?> &middot; <?php the_category(', ') ?></span>
				<span class="post-meta-comments"><?php edit_post_link(__('Edit', 'cp'), '', ' &middot; '); ?><?php comments_popup_link(__('No comments', 'cp'), __('One comment', 'cp'), '% '.__('comments', 'cp') ); ?></span>
